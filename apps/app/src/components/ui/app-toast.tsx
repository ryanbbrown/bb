...
export function AppToastContent({
  ...
  return (
    <div className="relative w-[var(--width,356px)] max-w-[calc(100vw-32px)] rounded-md border border-border bg-popover px-4 py-3 text-popover-foreground shadow-sm max-[600px]:w-[calc(100vw-32px)]">
...
function showAppToast({
  ...
  const { action, cancel, className, description, duration, ...sonnerOptions } =
    options ?? {};
  const nextDuration =
